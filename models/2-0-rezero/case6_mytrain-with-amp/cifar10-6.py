...
print(f"optimizer lr : ", each_trainings[0].optimizer.param_groups[0]["lr"])
print(f"optimizer momentum : ", each_trainings[0].optimizer.param_groups[0]["momentum"])
print(
    f"optimizer weight_decay : ",
    each_trainings[0].optimizer.param_groups[0]["weight_decay"],
)
